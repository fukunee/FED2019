...
> 为了便于大家分次阅读，我制作了一个页面，在每篇文章前加上选择框（选中checkbox表示已读）用于记录你已经读过的文章，便于下次回来时继续阅读。页面链接：[Frontend Tech List](https://alienzhou.github.io/frontend-tech-list/)
...
- Event Loop（面试里总会有一题 Event Loop…）：
    ...
    - [NodeJS 中的 Event Loop、Timers 与 `process.nextTick()`](https://nodejs.org/en/docs/guides/event-loop-timers-and-nexttick/)
...
- [如何完美实现一个非`button`元素的按钮](https://www.scottohara.me/blog/2018/10/03/unbutton-buttons.html)
...
- [webpack 中的 Chunk 关系图算法](https://medium.com/webpack/the-chunk-graph-algorithm-week-26-29-7c88aa5e4b4e)
- [webpack 进阶系列文章](https://juejin.im/post/5bc1a73df265da0a8d36b74f#heading-13)
- 编译优化：
    - [如何提升大型项目中 webpack 的性能 🎥](https://www.youtube.com/watch?v=AifDI71uqF0)
    - [运行时优化：Separating a Manifest](https://survivejs.com/webpack/optimizing/separating-manifest)
    - [在 webpack 中使用 \<link rel=”prefetch/preload”>](https://medium.com/webpack/link-rel-prefetch-preload-in-webpack-51a52358f84c)
...
- [Gulp 4 简介](https://fettblog.eu/gulp-4-parallel-and-series/)
...
- [图片懒加载完全指南](https://css-tricks.com/the-complete-guide-to-lazy-loading-images)
...
- [使用 Application Shell 架构来实现秒开应用](https://developers.google.com/web/updates/2015/11/app-shell)
...
- [什么导致强制同步布局（reflow）？](https://gist.github.com/paulirish/5d52fb081b3570c81e3a)
- [如何诊断强制同步布局](https://developers.google.com/web/tools/chrome-devtools/rendering-tools/forced-synchronous-layouts?hl=zh-cn)
- [无线性能优化：Composite](http://taobaofed.org/blog/2016/04/25/performance-composite/)
- [如何不择手段提升scroll事件的性能](https://zhuanlan.zhihu.com/p/30078937)
- [使用 passive event listener 来提高滚动流畅性](https://github.com/WICG/EventListenerOptions/blob/gh-pages/explainer.md)
...
- requestIdleCallback - 一个强大而神器的 API：
    - [requestIdleCallback使用入门](https://developers.google.com/web/updates/2015/08/using-requestidlecallback)
    - [Idle Until Urgent](https://philipwalton.com/articles/idle-until-urgent)：requestIdleCallback的妙用

### 3.3. 前端缓存

- [Web 缓存简介：以购买牛奶的为例](https://dev.to/kbk0125/web-caching-explained-by-buying-milk-at-the-supermarket-9k4)
- [大话前端缓存](https://calendar.perfplanet.com/2016/a-tale-of-four-caches/)
...
- [使用 Chrome DevTools 提升页面速度](https://developers.google.com/web/tools/chrome-devtools/speed/get-started)：Chrome DevTools实操讲解
...
- [前端性能测量](https://speedcurve.com/blog/user-timing-and-custom-metrics/)

### 3.5. 性能指标

- [以用户为中心的前端性能指标](https://developers.google.com/web/fundamentals/performance/user-centric-performance-metrics)：前端性能指标的来龙去脉
- DOMContentLoaded:
...
- [概念讲解：编码、加密、哈希与混淆](https://danielmiessler.com/study/encoding-encryption-hashing-obfuscation)
...
- [Site Isolation](https://developers.google.com/web/updates/2018/07/site-isolation)：Chrome的新特性
...
- [About `rel=noopener`](https://mathiasbynens.github.io/rel-noopener/)：打开一个新页面是如何带来安全隐患的
- [一种新型的“钓鱼”方式](http://www.azarask.in/blog/post/a-new-type-of-phishing-attack/)
...
- [对过多的 E2E 测试说“不”](https://testing.googleblog.com/2015/04/just-say-no-to-more-end-to-end-tests.html)
...
- [Service Worker 入门简介](https://medium.freecodecamp.org/service-workers-the-little-heroes-behind-progressive-web-apps-431cc22d0f16)
- [PWA 在 iOS 平台上的特殊问题](https://medium.com/@firt/pwas-are-coming-to-ios-11-3-cupertino-we-have-a-problem-2ff49fd7d6ea)
- [在你的 PWA 中小心使用 iOS 的 meta 标签](https://medium.com/@firt/dont-use-ios-web-app-meta-tag-irresponsibly-in-your-progressive-web-apps-85d70f4438cb)
...
- [Android 中的 WebAPKs](https://developers.google.cn/web/fundamentals/integration/webapks?hl=zh-cn)
- [Pinterest 的 PWA 实践](https://medium.com/@Pinterest_Engineering/a-one-year-pwa-retrospective-f4a2f4129e05)
- [异步 HTTP Cookies API](https://developers.google.com/web/updates/2018/09/asynchronous-access-to-http-cookies)：赋能Service Worker

### 7.2. CSS Houdini

- [认识 Houdini 与 CSS Paint API](https://codersblock.com/blog/say-hello-to-houdini-and-the-css-paint-api/)
- [用 Houdini 来拯救 CSS Polyfill](https://philipwalton.com/articles/the-dark-side-of-polyfilling-css/)

### 7.3. Web Components

- [Web Components 基本概念和用法](https://developer.mozilla.org/zh-CN/docs/Web/Web_Components)
- [Web Components 指南](https://css-tricks.com/modular-future-web-components/)
...
- [微前端主页](https://micro-frontends.org/)
...
- [全面介绍的 HTTP/2](https://hpbn.co/http2/)
- [HTTP/2 主页](https://http2.github.io/):
    - [HTTP/2 协议](https://httpwg.org/specs/rfc7540.html)
    - [HPACK: HTTP/2 Header压缩](https://httpwg.org/specs/rfc7541.html)
...
- [深入 WebSockets、HTTP/2 SSE](https://blog.sessionstack.com/how-javascript-works-deep-dive-into-websockets-and-http-2-with-sse-how-to-pick-the-right-path-584e6b8e3bf7)
